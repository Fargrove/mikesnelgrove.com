...
// .wrangler/tmp/bundle-vxBhoC/checked-fetch.js
...
// .wrangler/tmp/pages-Rieuvw/functionsWorker-0.10672958357762552.mjs
...
async function onRequestPost2(context) {
  ...
  try {
    ...
    const userId = user.id;
    const body = await request.json();
    const cutoffDate = /* @__PURE__ */ new Date("2026-06-11T00:00:00-04:00");
    if (/* @__PURE__ */ new Date() >= cutoffDate) {
...
// .wrangler/tmp/bundle-vxBhoC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-vxBhoC/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.10672958357762552.js.map
